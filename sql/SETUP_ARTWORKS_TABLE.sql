...
-- 
-- 📊 생성된 테이블:
-- - artworks (작품 게시물: title, description, image_url [NULL 허용])
--
-- 🗂️ Storage 버킷:
-- - posts (작품 이미지 저장소)
--
...
-- 🔄 스키마 캐시 갱신됨
--
-- 💡 실행 후 artworks 테이블의 컬럼 목록이 표시됩니다.
--
-- ==========================================
